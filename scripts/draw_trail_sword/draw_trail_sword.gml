/// @description draw_trail_sword(path,texture,segments,starting width,ending width,color,alpha)
/// @param path
/// @param texture
/// @param segments
...
/// @param color
/// @param alpha
function draw_trail_sword(path, texture, segments, starting, ending, color, alpha) {
	...
	if (pathlength>0)
	{
	    ...
	    for (i=seglength; i<1; i+=seglength;)
	    {
	        ...
	        draw_vertex_texture_color(xprev,yprev,i-seglength,0,color,alpha);
	    ...
	    draw_vertex_texture_color(xprev,yprev,1,0,color,alpha);
