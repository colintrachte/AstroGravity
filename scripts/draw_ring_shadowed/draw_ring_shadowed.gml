/// @description draw_ring_shadowed(x,y,inner radius,outer radius,# polygons,color1,color2,alpha1,alpha2,angle)
/// @param x
/// @param y
/// @param inner radius
/// @param outer radius
...
/// @param alpha2
/// @param angle
function draw_ring_shadowed(x, y, inner, outer, color1, color2, alpha1, alpha2, angle, arg9) {
