...
{
    in_view=point_in_rectangle(x,y,__view_get( e__VW.XView, 0 )-diameter*10,__view_get( e__VW.YView, 0 )-diameter*10,__view_get( e__VW.XView, 0 )+__view_get( e__VW.WView, 0 )+diameter*10,__view_get( e__VW.YView, 0 )+__view_get( e__VW.HView, 0 )+diameter*10);
    if in_view
    {
        //drawing
        if visible==0
